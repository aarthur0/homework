...
fsplit1=open("split1.txt","x")#100Mb new splitted files
fsplit1.seek(1024*1024*100)
fsplit2=open("split2.txt","x")
fsplit2.seek(1024*1024*100)
fsplit3=open("split3.txt","x")
fsplit3.seek(1024*1024*100)
fsplit4=open("split4.txt","x")
fsplit4.seek(1024*1024*100)
fsplit5=open("split5.txt","x")
fsplit5.seek(1024*1024*100)
fsplit6=open("split6.txt","x")
fsplit6.seek(1024*1024*100)
fsplit7=open("split7.txt","x")
fsplit7.seek(1024*1024*100)
fsplit8=open("split8.txt","x")
fsplit8.seek(1024*1024*100)
fsplit9=open("split9.txt","x")
fsplit9.seek(1024*1024*100)
fsplit10=open("split10.txt","x")
fsplit10.seek(1024*1024*100)
fsplit11=open("split11.txt","x")
fsplit11.seek(1024*1024*100)
fsplit12=open("split12.txt","x")
fsplit12.seek(1024*1024*100)
fsplit13=open("split13.txt","x")
fsplit13.seek(1024*1024*100)
fsplit14=open("split14.txt","x")
fsplit14.seek(1024*1024*100)
fsplit15=open("split15.txt","x")
fsplit15.seek(1024*1024*100)
fsplit16=open("split16.txt","x")
fsplit16.seek(1024*1024*100)
fsplit17=open("split17.txt","x")
fsplit17.seek(1024*1024*100)
fsplit18=open("split18.txt","x")
fsplit18.seek(1024*1024*100)
fsplit19=open("split19.txt","x")
fsplit19.seek(1024*1024*100)
fsplit20=open("split20.txt","x")
fsplit20.seek(1024*1024*100)
lst=[]
for i in file:
	lst=i.split()
